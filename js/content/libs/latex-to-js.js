...
var latex_to_js = function (input) {
    ...
    nth_power = function (input) {
        ...
        console.log(input, input.search(/\^/))
        if (input.search(/\^/) >= 0) {
